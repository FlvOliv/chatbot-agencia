...
**Versão 3.0** — Atualizada com base nos Processos Operacionais da agência
...
## 11. [NOVO] Regras sobre preços — baseado nos processos internos da agência
...
## 12. [NOVO] Aviso sobre variação de tarifas
...
## 13. [NOVO] Mensagem de follow-up (cliente sem resposta)
...
*Versão 3.0 — Renomeada para Malu. Incorporados os processos operacionais da agência: regra do preço de vitrine, aviso de variação de tarifas, linguagem alinhada à brand voice, CTAs da agência e regra absoluta de nunca mencionar valores.*
